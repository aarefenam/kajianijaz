...
const SEED = {
  ...
  users: [
    ...
    { id:'u5', nama:'Abdul Haris',                email:'web@alijaz.id',        password:'123456', role:'pj_mediaweb',status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Abdul Haris','#7C5CD6') },
    { id:'u6', nama:'M. Hariz Farezi',            email:'media@alijaz.id',      password:'123456', role:'pj_mediaweb',status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Hariz Farezi','#D9536F') },
    ...
    { id:'u8', nama:'Ust. Ahmad Zaky',            email:'buku@alijaz.id',       password:'123456', role:'pj_buku',    status:'aktif', angkatan:'Angkatan X',  level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Ahmad Zaky','#C77A2B') },
    ...
    { id:'u12', nama:'Salma Nabila', email:'salma@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XII', level:'Tatsqif', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Salma Nabila','#5B7C5F') },
    { id:'u13', nama:'Aisyah Kamila', email:'aisyah@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XII', level:'Tatsqif', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Aisyah Kamila','#6B8E6F') },
    { id:'u14', nama:'Hanif Musthafa', email:'hanif@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Hanif Musthafa','#4A8751') },
    { id:'u15', nama:'Zaki Mubarak', email:'zaki@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Zaki Mubarak','#3D7A42') },
    { id:'u16', nama:'Yusuf Abdurrahman', email:'yusuf@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Yusuf Abdurrahman','#8A7A5C') },
    { id:'u17', nama:'Imam Baihaqi', email:'imam@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Imam Baihaqi','#7A8B7F') },
    { id:'u18', nama:'Nuzul Fikri Ramadhan', email:'nuzul@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Nuzul Fikri Ramadhan','#5B7C5F') },
    { id:'u19', nama:'Faiz Abdillah', email:'faiz@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Faiz Abdillah','#6B8E6F') },
    { id:'u20', nama:'Lutfi Hakim', email:'lutfi@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XII', level:'Level 1', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Lutfi Hakim','#4A8751') },
    { id:'u21', nama:'Raihan Maulida', email:'raihan@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XII', level:'Level 1', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Raihan Maulida','#3D7A42') },
    { id:'u22', nama:'Syifa Aulia', email:'syifa@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Syifa Aulia','#8A7A5C') },
    { id:'u23', nama:'Naufal Ihsan', email:'naufal@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Naufal Ihsan','#7A8B7F') },
    { id:'u24', nama:'Adib Fauzan', email:'adib@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan IX', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Adib Fauzan','#5B7C5F') },
    { id:'u25', nama:'Hamzah Ridwan', email:'hamzah@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan IX', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Hamzah Ridwan','#6B8E6F') },
    { id:'u26', nama:'Ulya Rahmah', email:'ulya@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan IX', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Ulya Rahmah','#4A8751') },
    { id:'u27', nama:'Bilal Arkan', email:'bilal@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VIII', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Bilal Arkan','#3D7A42') },
    { id:'u28', nama:'Zahra Husna', email:'zahra@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VIII', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Zahra Husna','#8A7A5C') },
    { id:'u29', nama:'Rifqi Anwar', email:'rifqi@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VII', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Rifqi Anwar','#7A8B7F') },
    { id:'u30', nama:'Sulthan Habib', email:'sulthan@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VII', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Sulthan Habib','#5B7C5F') },
    { id:'u31', nama:'Nabil Fathan', email:'nabil@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VI', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Nabil Fathan','#6B8E6F') },
    { id:'u32', nama:'Aqila Zahira', email:'aqila@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan VI', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Aqila Zahira','#4A8751') },
    { id:'u33', nama:'Umar Faruq', email:'umar@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan V', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Umar Faruq','#3D7A42') },
    { id:'u34', nama:'Ikhsan Nabawi', email:'ikhsan@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan IV', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Ikhsan Nabawi','#8A7A5C') },
    { id:'u35', nama:'Zulfa Amalia', email:'zulfa@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan III', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Zulfa Amalia','#7A8B7F') },
    { id:'u36', nama:'Hasan Basri', email:'hasanb@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan II', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Hasan Basri','#5B7C5F') },
    { id:'u37', nama:'Anas Mubarok', email:'anas@alijaz.id', password:'123456', role:'anggota', status:'alumni', angkatan:'Angkatan I', level:'Alumni', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'alumni', foto:avatar('Anas Mubarok','#6B8E6F') },
    { id:'u38', nama:'Ust. Anwar Sadad', email:'kajian@alijaz.id', password:'123456', role:'pj_kajian', status:'aktif', angkatan:'Angkatan IX', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Anwar Sadad','#C77A2B') },
    { id:'u39', nama:'Rezi Fahrezi', email:'rezi@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Rezi Fahrezi','#5B7C5F') },
    { id:'u40', nama:'Irfan Maulana', email:'irfan@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Irfan Maulana','#6B8E6F') },
    { id:'u41', nama:'Lalu Hakim', email:'lalu@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Lalu Hakim','#4A8751') },
    { id:'u42', nama:'Adya Rahmani', email:'adya@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XI', level:'Level 2', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Adya Rahmani','#3D7A42') },
    { id:'u43', nama:'Mona Khairunnisa', email:'mona@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan XII', level:'Level 1', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Mona Khairunnisa','#8A7A5C') },
    { id:'u44', nama:'Ridho Alfarizi', email:'ridho@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Ridho Alfarizi','#4A8751') },
    { id:'u45', nama:'Syahrul Munir', email:'syahrul@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Syahrul Munir','#3D7A42') },
    { id:'u46', nama:'Anisa Fitria', email:'anisa@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Anisa Fitria','#8A7A5C') },
    { id:'u47', nama:'Bagas Prakoso', email:'bagas@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Bagas Prakoso','#7A8B7F') },
    { id:'u48', nama:'Dina Maulida', email:'dina@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Dina Maulida','#5B7C5F') },
    { id:'u49', nama:'Fauzan Adhim', email:'fauzan@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Fauzan Adhim','#6B8E6F') },
    { id:'u50', nama:'Ghina Salsabila', email:'ghina@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Ghina Salsabila','#4A8751') },
    { id:'u51', nama:'Hafizh Rahman', email:'hafizh@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Hafizh Rahman','#3D7A42') },
    { id:'u52', nama:'Iqbal Ramadhan', email:'iqbal@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Iqbal Ramadhan','#8A7A5C') },
    { id:'u53', nama:'Julia Rahmawati', email:'julia@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Julia Rahmawati','#7A8B7F') },
    { id:'u54', nama:'Kamal Abdullah', email:'kamal@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Kamal Abdullah','#5B7C5F') },
    { id:'u55', nama:'Laila Nurhaliza', email:'laila@alijaz.id', password:'123456', role:'anggota', status:'aktif', angkatan:'Angkatan X', level:'Level 3', pendidikan:"S1 Tafsir & Ilmu al-Quran, Universitas Al-Azhar Kairo", kategori:'anggota', foto:avatar('Laila Nurhaliza','#6B8E6F') },
  ],
